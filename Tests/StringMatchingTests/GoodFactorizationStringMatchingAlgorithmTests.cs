...
{
    [TestFixture]
    public class GoodFactorizationStringMatchingAlgorithmTests
    {
        ...
        public void TestFindOccurences(string text, string pattern, int[] expectedOccurences)
        {
            ...
            var algorithm =
                new GoodFactorizationStringMatchingAlgorithm(sb, 0, pattern, pattern.Length, criticalPosition, period);
